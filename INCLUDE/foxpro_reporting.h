...
&&	defined in foxpro.h		#DEFINE MB_OK                   0       && OK button only
#DEFINE MB_OKCANCEL             1       && OK and Cancel buttons
&&	defined in foxpro.h		#DEFINE MB_ABORTRETRYIGNORE     2       && Abort, Retry, and Ignore buttons
#DEFINE MB_YESNOCANCEL          3       && Yes, No, and Cancel buttons
&&	defined in foxpro.h		#DEFINE MB_YESNO                4       && Yes and No buttons
#DEFINE MB_RETRYCANCEL          5       && Retry and Cancel buttons

#DEFINE MB_ICONSTOP             16      && Critical message
#DEFINE MB_ICONQUESTION         32      && Warning query
&&	defined in foxpro.h		#DEFINE MB_ICONEXCLAMATION      48      && Warning message
...
&&	defined in foxpro.h		#DEFINE IDYES           6       && Yes button pressed
